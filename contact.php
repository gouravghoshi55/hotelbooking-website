    ...
    <div class="row">
      <div class="col-lg-6 col-md-6 mb-5 px-4">
        <div class="bg-white rounded shadow p-4 ">
          <iframe class="w-100 rounded mb-4" src="https://www.google.com/maps/d/embed?mid=1CyDLpFkhj9U21GWYYjbbK6FVs6o&hl=en_US&ehbc=2E312F" height="480"></iframe>
          <h5>Address</h5>
          <a href="" target="_blank" class="d-inline-block text-decoration-none text-dark mb-2">
            <i class="bi bi-geo-alt-fill"></i>Kokta Anand nagar , Bhopal M.P.
          </a>
          ...
          <h5 class="mt-4">
            Email</h5>
          <a href="mailto: ask.GPhotels@gmail.com" class="d-inline-block  text-decoration-none text-dark">
            <i class="bi bi-envelope-fill"></i> ask.GPhotels@gmail.com<br>
          </a>
          <br>
